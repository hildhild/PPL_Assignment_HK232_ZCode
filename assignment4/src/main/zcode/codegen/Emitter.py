...
class Emitter():
    ...
    def getJVMType(self, inType):
        ...
        if typeIn is BoolType: #* kiểu bool
            ...
            return "LZCodeClass;"
        elif typeIn is VarSymbol: #* kiểu VarSymbol chỉ khi type = None, cần lưu line ở chỉnh sau này
            return "None"
        elif typeIn is FuncSymbol: #* có 2 giống ý tưởng VarSymbol
    ...
    def emitMETHOD(self, lexeme, in_, isStatic, frame):
        ...
        #& in_: Type (type của hàm FUNCSymbol)
